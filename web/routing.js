"use strict";
const ROUTE_VIEWS=["workspaces","overview","mission","runReadiness","phaseCheckpoints","decisions","queue","workers","knowledge","metrics","usage","gitStatus","artifacts","roadmap","readiness"];
