...
- [ ] WSP-04C3: independently verified resource/host observations, coordinated settlement/runner handling and explicit reconciled ownership release; new-generation continuation approval and native transport before exact owner Play activation
